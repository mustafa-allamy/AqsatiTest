...
{
    public class CreateGeneralVacationTypeForm : BaseForm<CreateGeneralVacationTypeForm, GeneralVacationType>, ICommand<SuccessServiceResponse<GeneralVacationTypeDto>>
    {
