...
{
    public class UpdateDepartmentVacationTypeForm : BaseForm<UpdateDepartmentVacationTypeForm, DepartmentVacationType>, ICommand<SuccessServiceResponse<DepartmentVacationTypeDto>>
    {
